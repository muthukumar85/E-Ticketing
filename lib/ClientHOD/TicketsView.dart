...
class ClientHODTicket extends StatefulWidget {
  const ClientHODTicket({Key? key , required this.userinfo, required this.tickets}) : super(key: key);
  final Map userinfo;
  final Map tickets;
  @override
  State<ClientHODTicket> createState() => _ClientHODTicketState();
}

class _ClientHODTicketState extends State<ClientHODTicket>  {
