...
class ClientUserTicket extends StatefulWidget {
  const ClientUserTicket({Key? key , required this.userinfo , required this.tickets }) : super(key: key);
  final Map userinfo;
  final Map tickets;
  @override
  State<ClientUserTicket> createState() => _ClientUserTicketState();
}

class _ClientUserTicketState extends State<ClientUserTicket>  {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBars(name: '(User) ${widget.userinfo['name'].toString().replaceFirst(widget.userinfo['name'][0], widget.userinfo['name'][0].toString().toUpperCase())}', isreload: true, islogout: true, context: context),
            ...
            Navigator.push<dynamic>(
              ...
              MaterialPageRoute<dynamic>(
                builder: (BuildContext context) =>
                    CreateTicket(
                      userinfo: widget.userinfo, Units: {}),
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                      color: data["ticket_state"]=="closed"?ArgonColors.success:data["ticket_status"]=="open"?ArgonColors.pending:ArgonColors.error,
