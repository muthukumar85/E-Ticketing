...
class SuperAdminTicket extends StatefulWidget {
  const SuperAdminTicket({Key? key , required this.userinfo , required this.tickets}) : super(key: key);
  final Map userinfo;
  final Map tickets;
  @override
  State<SuperAdminTicket> createState() => _SuperAdminTicketState();
}

class _SuperAdminTicketState extends State<SuperAdminTicket> {
               ...
               children: [
                 Container(
                   ...
                   decoration: BoxDecoration(
                       color: data["ticket_state"]=="closed"?ArgonColors.success:data["ticket_state"]=="open"?ArgonColors.pending:ArgonColors.error,
                 ...
                 SizedBox(
                   ...
                   child: Column(
                     mainAxisAlignment: MainAxisAlignment.center,
                     children: [
                       Text(data['clientname'] , style: TextStyle(color: ArgonColors.text , fontWeight: FontWeight.bold),),
